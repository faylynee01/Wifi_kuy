...
<body class="register-page bg-body-secondary">
    <div class="register-box">
        <div class="register-logo"> <a href="<?= BASE_URL ?>"><?= $pengaturan['nama_web'] ?></a> </div> <!-- /.register-logo -->
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="<?= BASE_URL . 'register-action' ?>" method="post">
                    <div class="input-group mb-3"> <input type="text" class="form-control" name="nama" placeholder="Full Name">
                ...
                <p class="mb-0"> <a href="<?= BASE_URL . 'login' ?>" class="text-center">
